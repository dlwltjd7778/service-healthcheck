package com.opsnow.healthcheck.common.constants.notification;
    ...
    public enum NotiErrorMsg{
        ...
        CANNOT_FIND_EVENT_ID_FROM_WEBHOOK("WebHook으로 전송된 UUID 가 DB(Redis)에 저장되어 있지 않음."),
        CANNOT_FIND_EVENT_ID_IN_REDIS("HealthCheckEventIdList 의 eventId가 DB(Redis)에 저장되어 있지 않음.");
